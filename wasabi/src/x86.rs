...
pub enum TranslationResult {
    PageMapped4K { phis: u64 },
    PageMapped2M { phis: u64 },
    PageMapped1G { phis: u64 },
}
...
impl<const LEVEL: usize, NEXT> Entry<LEVEL, NEXT> {
    ...
    fn is_present(&self) -> bool {
        (self.read_value() & ATTR_PRESENT) != 0
    }
...
/// # Safety
/// Writing to CR3 causes any exceptions so it is
...
/// # Safety
/// This will create a mutable reference to the page structure
/// So is programmer's responsibility to ensure that at most one
...
pub unsafe fn write_cs(cs: u16) {
    // The MOV instruction CANNOT be used to load CS register.
...
extern "sysv64" fn inthandler(info: &InterruptInfo, index: usize) {
    ...
    match index {
        ...
        14 => {
            ...
            error!(
                "Caused by: A {} mode {} on a {} page, pag structures are {}",
...
impl GdtWrapper {
    pub fn load(&self) {
        ...
        // SAFETY: This is safe since it loading a valid GDT just constructed in the above
        unsafe {
